...
#     print ("nb fenetres ", len(tSignalHamminged))
    if (bDurees):
...
#     %matplotlib inline
    ...
    if (bDurees):
        nTps = time.process_time()
    dataModded, tZRC, tZREnergie, _ = detectVoix(data, 1000, bExcluSilences=True) # 30 bien sur son propre, son bruité seuil à 1000
    if (bDurees):
...
#     nCurseurFinLecture = nLongueurMinSonConnu
    ...
    if (bDetails):
#         print("longueur original ", len(tSonsInconnus))
#         print("longueur modded ", len(dataModded))
#         print("longueur zrc ", len(tZRC))
#         print("longueur energie ", len(tZREnergie))
#         print("longueur decal ", nDecalageStartPlot)
    ...
    #                 print("proche ", nDistanceProche, "  ", sNomProche)
    #                 print("min ", nDistanceMin, " ", sSonTrouve)
    #                 print("Ancien ", nDistanceAncien)
...
evalueComplexe("sound/test.wav", nSeuilIgnorer=3000)
# evalueComplexe("sound/yann1_sale.wav", bDetails=True, nSeuilIgnorer=1000)
# evalueComplexe("sound/yann1_sale2.wav", bDetails=False, nSeuilIgnorer=1000)


# In[ ]:


evalueComplexe("sound/custom 4b8.wav", bDetails=True)
...
AfficheLectureEnregistrement("sound/yann1_sale.wav")


# In[ ]:


AfficheLectureEnregistrement("sound/test.wav")
